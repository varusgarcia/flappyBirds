...
float xPosGrid = 0;
float gravity = 0;
float wiggleAngle = 0.0;
float wiggleSpeed = 0.3;
float count = 0;
int yPosFirst = 240;
...
imageMode(CORNERS);
  ...
  if ( xPosTube < 204 && xPosTube > 89){      
    inTube = true;
  }
  else { 
    inTube = false;
  }
     if ( x1PosTube < 204 && x1PosTube > 89){
    inTube1 = true;
  }
  else { 
    inTube1 = false;
  ...
  if  ((( yPosBird -27  < yPosTube + 911 && inTube == true)  || (yPosBird + 27 > yPosTube + 911 + 215 && inTube == true)) || (( yPosBird -27 < y1PosTube + 911 && inTube1 == true)  || (yPosBird + 27  > y1PosTube + 911 + 215 && inTube1 == true))){
    gameOverFall = true;  
    }
...
if (currentNumber == 1 && currentNumber10 == 1 && currentNumber100 != 1){             ////[]11
 ...
 playLeader = playLeader-30;
  ...
  if (tintGameOver >= 245){
   ...
   if ( currentNumberTotal >= bestNum ){
     bestNum = currentNumberTotal;
     bestNum1 = currentNumber;
     bestNum10 = currentNumber10;
     bestNum100 = currentNumber100;
     image(numbersScore [currentNumber],492,515);
   
     if( currentNumberTotal >=10){
     image(numbersScore [currentNumber10],455,515);
     }
   
     if( currentNumberTotal >=100){
     image(numbersScore [currentNumber100],418,515);
     }
   }
   
     image(numbersScore [bestNum1],492,515);
   
     if( bestNum >=10){
     image(numbersScore [bestNum10],455,515);
     }
   
     if( bestNum100 >=100){
     image(numbersScore [bestNum100],418,515);
     }
   println(bestNum);
